                ...
                <div className="mx-auto max-w-6xl px-4">
                    <div className="bg-gradient-to-r from-red-50 to-orange-50 border-2 border-red-200 rounded-3xl p-12">
                        ...
                        <p className="text-zinc-700 text-lg leading-relaxed">
                            Бид гаалийн бүрдүүлэлт, бичиг баримтаа боловсруулалт, түр агуулахад хадгалалт зэрэг <b>бүрэн үйлчилгээ</b> үзүүлнэ.
                            Манай мэргэжлийн баг та болон та болор ачаагүй томоо асуудлыг шийдвэрлэх боломжтой.
                        </p>
